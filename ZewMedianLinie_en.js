...
// definition of text labels
  var chartTitel ="2014 real annual rate of change in per cent";
  //var chartTitel2 ="Monatliche Revision der Prognose in Prozentpunkten";
  var xAxisLabel ="month of forecast release";
  var lineLabel1 ="median";
  var lineLabel2 ="maximum";
  var lineLabel3 ="minimum";
  var lineLabel4 ="forecast";
  var revLabel = "revision (percentage points)";
  var button1Text ="show monthly revisions";	
  var button2Text ="go back to median forecast";
  ...
  var formatTime = en.timeFormat("%b %Y");
  var parseDate = d3.time.format("%Y").parse; 
  var ge_monat = en.timeFormat("%b");
  var ge_jahr = en.timeFormat("%Y");
  //var ge_zahl = en.numberFormat("4n");
  var ge_zahl = en.numberFormat(",.1f");
  var ge_skalenZahl = en.numberFormat(",.1f");
